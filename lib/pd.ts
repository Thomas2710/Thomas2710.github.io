...
export const cards: Placecard[] = [
  ...
  { id: 11, title: 'Casa Barozzi', nazionalità: 'Italiano', description: 'Panineria', category: 'Cibo', link:'https://casabarozzi.com/', rating: 0, imageUrl: '/logos/Italia.png' },
  { id: 12, title: 'MexiCani', nazionalità: 'Messicano', description: 'Ristorante messicano', category: 'Cibo', link:'https://www.mexicanitaqueria.com/it/our-menu', rating: 0, imageUrl: '/logos/Messico.png' },
